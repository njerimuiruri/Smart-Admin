...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Scrollspy - UI Components - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Scrollspy">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Navbar <span class="fw-300"><i>example</i></span>
                                        </h2>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <div class="demo-window rounded shadow-1">
                                                <div class="demo-window-content">
                                                    <nav id="spyscroll-1" class="navbar bg-fusion-500 px-4 py-2">
                                                        <a class="navbar-brand fw-500 text-white" href="#">Navbar</a>
                                                        <ul class="nav nav-pills">
                                                            <li class="nav-item">
                                                                <a class="nav-link text-white active" href="#spyscroll-1-a">&commat;fat</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link text-white" href="#spyscroll-1-b">&commat;mdo</a>
                                                            </li>
                                                            <li class="nav-item dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="#spyscroll-1-c">one</a>
                                                                    <a class="dropdown-item" href="#spyscroll-1-d">two</a>
                                                                    <div role="separator" class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="#spyscroll-1-e">three</a>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                    <div data-spy="scroll" data-target="#spyscroll-1" data-offset="0" class="p-4 overflow-auto" style="height:250px">
                                                        <h4 id="spyscroll-1-a">&commat;fat</h4>
                                ...
                                <div id="panel-2" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            List-group <span class="fw-300"><i>example</i></span>
                                        </h2>
                                        <div class="panel-toolbar">
                                            <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="Collapse"></button>
                                            <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Fullscreen"></button>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                Scrollspy also works with <code>.list-groups</code>. Scroll the area next to the list group and watch the active class change.
                                            </div>
                                            <div class="demo-window rounded shadow-1">
                                                <div class="demo-window-content">
                                                    <div class="row no-gutters">
                                                        <div class="col-3">
                                                            <div id="spyscroll-2" class="list-group p-3">
                                                                <a class="list-group-item list-group-item-action" href="#spyscroll-2-a">Item 1</a>
                                                                <a class="list-group-item list-group-item-action" href="#spyscroll-2-b">Item 2</a>
                                                                <a class="list-group-item list-group-item-action" href="#spyscroll-2-c">Item 3</a>
                                                                <a class="list-group-item list-group-item-action" href="#spyscroll-2-d">Item 4</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-9">
                                                            <div data-spy="scroll" data-target="#spyscroll-2" data-offset="0" class="position-relative overflow-auto px-2 py-3" style="height:250px">
                                                                <h4 id="spyscroll-2-a">Item 1</h4>
                                                                <p>Ex consequat commodo adipisicing exercitation aute excepteur occaecat ullamco duis aliqua id magna ullamco eu. Do aute ipsum ipsum ullamco cillum consectetur ut et aute consectetur labore. Fugiat laborum incididunt tempor eu consequat enim dolore proident. Qui laborum do non excepteur nulla magna eiusmod consectetur in. Aliqua et aliqua officia quis et incididunt voluptate non anim reprehenderit adipisicing dolore ut consequat deserunt mollit dolore. Aliquip nulla enim veniam non fugiat id cupidatat nulla elit cupidatat commodo velit ut eiusmod cupidatat elit dolore.</p>
                                                                <h4 id="spyscroll-2-b">Item 2</h4>
                                                                <p>Quis magna Lorem anim amet ipsum do mollit sit cillum voluptate ex nulla tempor. Laborum consequat non elit enim exercitation cillum aliqua consequat id aliqua. Esse ex consectetur mollit voluptate est in duis laboris ad sit ipsum anim Lorem. Incididunt veniam velit elit elit veniam Lorem aliqua quis ullamco deserunt sit enim elit aliqua esse irure. Laborum nisi sit est tempor laborum mollit labore officia laborum excepteur commodo non commodo dolor excepteur commodo. Ipsum fugiat ex est consectetur ipsum commodo tempor sunt in proident.</p>
                                                                <h4 id="spyscroll-2-c">Item 3</h4>
                            ...
                            <div class="col-xl-6">
                                <div id="panel-3" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Nested <span class="fw-300"><i>example</i></span>
                                        </h2>
                                        <div class="panel-toolbar">
                                            <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="Collapse"></button>
                                            <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Fullscreen"></button>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                Scrollspy also works with nested <code>.nav</code>s. If a nested <code>.nav</code> is <code>.active</code>, its parents will also be <code>.active</code>. Scroll the area next to the navbar and watch the active class change
                                            </div>
                                            <div class="demo-window rounded shadow-1">
                                                <div class="demo-window-content">
                                                    <div class="row no-gutters">
                                                        <div class="col-auto width-sm">
                                                            <nav id="spyscroll-3" class="navbar align-items-start p-2 flex-column h-100 bg-fusion-500">
                                                                <nav class="nav nav-pills flex-column w-100">
                                                                    <a class="nav-link active text-white" href="#item-1">Item 1</a>
                                                                    <nav class="nav nav-pills flex-column">
                                                                        <a class="nav-link ml-3 my-1 active text-white" href="#item-1-1">Item 1-1</a>
                                                                        <a class="nav-link ml-3 my-1 text-white" href="#item-1-2">Item 1-2</a>
                                                                    </nav>
                                                                    <a class="nav-link text-white" href="#item-2">Item 2</a>
                                                                    <a class="nav-link text-white" href="#item-3">Item 3</a>
                                                                    <nav class="nav nav-pills flex-column">
                                                        ...
                                                        <div class="col">
                                                            <div data-spy="scroll" data-target="#spyscroll-3" data-offset="10" class="position-relative overflow-auto p-4" style="height:650px">
                                                                <div class="jumbotron p-4 rounded" id="item-1">
                                                                    <h1 class="display-4">Hello, world!</h1>
                                                                    <p class="lead">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                                                                </div>
                                                                <h2 class="fw-500">Item 1</h2>
                                                                <p>Ex consequat commodo adipisicing exercitation aute excepteur occaecat ullamco duis aliqua id magna ullamco eu. Do aute ipsum ipsum ullamco cillum consectetur ut et aute consectetur labore. Fugiat laborum incididunt tempor eu consequat enim dolore proident. Qui laborum do non excepteur nulla magna eiusmod consectetur in. Aliqua et aliqua officia quis et incididunt voluptate non anim reprehenderit adipisicing dolore ut consequat deserunt mollit dolore. Aliquip nulla enim veniam non fugiat id cupidatat nulla elit cupidatat commodo velit ut eiusmod cupidatat elit dolore.</p>
                                                                ...
                                                                <h2 id="item-2" class="fw-500">Item 2</h2>
                                                                <p>Quis magna Lorem anim amet ipsum do mollit sit cillum voluptate ex nulla tempor. Laborum consequat non elit enim exercitation cillum aliqua consequat id aliqua. Esse ex consectetur mollit voluptate est in duis laboris ad sit ipsum anim Lorem. Incididunt veniam velit elit elit veniam Lorem aliqua quis ullamco deserunt sit enim elit aliqua esse irure. Laborum nisi sit est tempor laborum mollit labore officia laborum excepteur commodo non commodo dolor excepteur commodo. Ipsum fugiat ex est consectetur ipsum commodo tempor sunt in proident.</p>
                                                                <p>Ex consequat commodo adipisicing exercitation aute excepteur occaecat ullamco duis aliqua id magna ullamco eu. Do aute ipsum ipsum ullamco cillum consectetur ut et aute consectetur labore. Fugiat laborum incididunt tempor eu consequat enim dolore proident. Qui laborum do non excepteur nulla magna eiusmod consectetur in. Aliqua et aliqua officia quis et incididunt voluptate non anim reprehenderit adipisicing dolore ut consequat deserunt mollit dolore. Aliquip nulla enim veniam non fugiat id cupidatat nulla elit cupidatat commodo velit ut eiusmod cupidatat elit dolore.</p>
                                                                <h2 id="item-3" class="fw-500">Item 3</h2>
                                                                <p>Quis anim sit do amet fugiat dolor velit sit ea ea do reprehenderit culpa duis. Nostrud aliqua ipsum fugiat minim proident occaecat excepteur aliquip culpa aute tempor reprehenderit. Deserunt tempor mollit elit ex pariatur dolore velit fugiat mollit culpa irure ullamco est ex ullamco excepteur.</p>
                                                                <p>Ex consequat commodo adipisicing exercitation aute excepteur occaecat ullamco duis aliqua id magna ullamco eu. Do aute ipsum ipsum ullamco cillum consectetur ut et aute consectetur labore. Fugiat laborum incididunt tempor eu consequat enim dolore proident. Qui laborum do non excepteur nulla magna eiusmod consectetur in. Aliqua et aliqua officia quis et incididunt voluptate non anim reprehenderit adipisicing dolore ut consequat deserunt mollit dolore. Aliquip nulla enim veniam non fugiat id cupidatat nulla elit cupidatat commodo velit ut eiusmod cupidatat elit dolore.</p>
