                                ...
                                <div id="panel-2" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <h5 class="frame-heading">
                                                Custom <a href="utilities_color_pallet" title="Color Pallets"><i class="fal fa-reply"></i> </a>
                                            </h5>
                                            <div class="frame-wrap">
                                                <table class="table m-0">
                            ...
                            <div class="col-lg-12 col-xl-6">
                                ...
                                <div id="panel-6" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                Use contextual classes to color table rows or individual cells. See the full list of <a href="utilities_color_pallet" title="Color Pallets" target="_blank">color selection</a>
                                            </div>
                                            <table class="table m-0">
                                                <thead>
                                                    <tr>
                                ...
                                <div id="panel-7" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                Add <code> .table-sm</code> to make tables more compact by cutting cell padding in half. See the full list of <a href="utilities_color_pallet" title="Color Pallets">color selection</a> to add backgrounds as well
                                            </div>
                                            <h5 class="frame-heading">
                                                Compact
                                            </h5>
