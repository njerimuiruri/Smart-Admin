...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Spacing - Utilities - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Spacing">
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <a href="https://getbootstrap.com/docs/4.5/utilities/spacing/" target="_blank">official documentation</a> also on this <a href="https://codepen.io/nextgenadmin/pen/VRExxJ" target="_blank">codepen example</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div id="panel-3" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                The syntax is nearly the same as the default, positive margin utilities, but with the addition of <code>n</code> before the requested size.
                                            </div>
                                            <p>
