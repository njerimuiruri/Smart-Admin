...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Tabs &amp; Pills">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Tabs &amp; Pills</li>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div id="panel-3" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                Direction of the tabs can be changed by adding <code>.justify-content-end</code> and <code>justify-content-center</code> to <code>.nav.nav-tabs</code>
                                                <br>
                                                <br>
                                                <div id="js_change_tab_direction" class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-info active">
                                                        <input type="radio" name="radioNameTabDirection" checked="" value="nav nav-tabs"> Left aligned
                                                    </label>
                                ...
                                <div id="panel-5" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#tab_borders_icons-1" role="tab"><i class="fal fa-home mr-1"></i> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#tab_borders_icons-2" role="tab"><i class="fal fa-user mr-1"></i> Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#tab_borders_icons-3" role="tab"><i class="fal fa-clock mr-1"></i> Time</a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <div class="demo-v-spacing">
                                                <nav class="nav nav-pills">
                                                    <a class="nav-item nav-link active btn-xs" href="#" data-toggle="pill"><i class="fal fa-home mr-1"></i> Home</a>
                                                    <a class="nav-item nav-link btn-xs" href="#" data-toggle="pill"><i class="fal fa-user mr-1"></i> Profile</a>
                                                    <a class="nav-item nav-link btn-xs" href="#" data-toggle="pill"><i class="fal fa-cog mr-1"></i> Settings</a>
                                                </nav>
                                                <nav class="nav nav-pills">
                                                    <a class="nav-item nav-link active btn-lg" href="#" data-toggle="pill"><i class="fal fa-home mr-1"></i> Home</a>
                                                    <a class="nav-item nav-link btn-lg" href="#" data-toggle="pill"><i class="fal fa-user mr-1"></i> Profile</a>
                                                    <a class="nav-item nav-link btn-lg" href="#" data-toggle="pill"><i class="fal fa-cog mr-1"></i> Settings</a>
                                                </nav>
                                                <nav class="nav nav-pills">
                                                    ...
                                                    <a class="nav-item nav-link  btn btn-icon btn-lg rounded-circle" href="#" data-toggle="pill"><i class="fal fa-cog"></i></a>
                                                </nav>
                                                <nav class="nav nav-pills">
                                                    ...
                                                    <a class="nav-item nav-link  btn btn-icon rounded-circle" href="#" data-toggle="pill"><i class="fal fa-cog"></i></a>
                                                </nav>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                ...
                                                <br>
                                                <br>
                                                <div id="js_change_pill_direction" class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-success active">
                                                        <input type="radio" name="radioNamePillDirection" checked="" value="nav nav-pills"> Left aligned
                                                    </label>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="border px-3 pt-3 pb-0 rounded">
                                                <ul class="nav nav-pills" role="tablist">
                                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#js_pill_border_icon-1"><i class="fal fa-home mr-1"></i>Home</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#js_pill_border_icon-2"><i class="fal fa-user mr-1"></i>Profile</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#js_pill_border_icon-3"><i class="fal fa-clock mr-1"></i>Time</a></li>
                                                </ul>
                                                <div class="tab-content py-3">
