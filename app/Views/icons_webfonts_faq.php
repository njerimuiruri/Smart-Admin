...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Base - Font Icons - SmartAdmin v4.5.1
        </title>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                Webfonts <span class='fw-300'>FAQ</span>
                                <small>
                        ...
                        <div class="alert alert-primary">
                            <div class="d-table w-100">
                                ...
                                <div class="d-table-cell align-middle pl-1">
                                    ...
                                    <br> Base Icons are primarily used as a 'base' layer for <strong>Stack Icons</strong>, but may also be used as regular general icons. To see base icons in action see the <a href="icons_stack_showcase" target="_blank">Stack Icons Showcase</a> page.
                                </div>
                            </div>
                        </div>
                        <div class="row">
