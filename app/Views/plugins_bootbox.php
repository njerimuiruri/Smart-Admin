...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            BootBox - Core Plugins - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="BootBox">
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p class="m-0">
                                            Find in-depth, guidelines, tutorials and more on BootBox's <a href="http://bootboxjs.com/documentation" target="_blank">Official Documentation</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            $(document).ready(function()
            {
                ...
                $("#js-bootbox-example-22").on("click", function()
                {
                    ...
                    dialog.init(function()
                    {
                        setTimeout(function()
                        {
                            dialog.find('.bootbox-body')('I was loaded after the dialog was shown!');
                        }, 3000);
                    });
                });
