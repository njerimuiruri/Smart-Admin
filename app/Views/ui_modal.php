...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Modal - UI Components - SmartAdmin v4.5.1
        </title>
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p class="m-0">
                                            Find in-depth, guidelines, tutorials and more on Bootstrap Modals's at the <a href="https://getbootstrap.com/docs/4.5/components/modal" class="fw-500" target="_blank">official bootstrap site</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
