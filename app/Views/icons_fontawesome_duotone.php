...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Duotone - Font Icons - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Duotone">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">Fontawesome 5</li>
                            <li class="breadcrumb-item active">Duotone</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader">
                            <h1 class="subheader-title">
                                Font Awesome 5: <span class='fw-300'>Duotone</span>
                                <small>
                                    Font Awesome 5 Pro Duotone
                                </small>
                            </h1>
                        </div>
        ...
        <script>
            /*webfont prefix*/
            var prefix = "fad"; //fal fas far fab ni etc
            var prefix_extend = "fa" //fa-icon

            /*JSON file that will be loaded*/
            var filename = "media/data/fa-duotone"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list, fa-icon-duotone]
