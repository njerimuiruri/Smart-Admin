...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Spinners - UI Components - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Spinners">
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <br>
                                        <br>
                                        Learn more about this plugin on bootstrap's <a href="https://getbootstrap.com/docs/4.5/components/spinners/" target="_blank">official documentation</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div id="panel-2" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                The border spinner uses <code>currentColor</code> for its <code>border-color</code>, meaning you can customize the color with <a href="#" target="_blank">text color utilities</a>. You can use any of our text color utilities on the standard spinner
                                            </div>
                                            <div class="demo">
